...
public class UserGroupController extends BaseController {
	...
	public String add(HttpServletRequest request, Usergroup userGroup) {
		...
		// 获取当前登录用户
		ShiroUser loginUser = (ShiroUser) SecurityUtils.getSubject().getPrincipals().getPrimaryPrincipal();
		...
		try {
			...
			e.printStackTrace();
			log.error("[UserGroupController-add()]：错误原因:" + e.getMessage());
			return "";
		}
	}
	...
	/**
	 * 
	 * @Title: update @Description: 修改用户组 @param @param request @param @param
	 * userGroup @param @return 设定文件 @return String 返回类型 @throws
	 */
	@ResponseBody
	...
	public String update(HttpServletRequest request, Usergroup userGroup) {
		...
		try {
			...
			e.printStackTrace();
			log.error("[UserGroupController-update()]：错误原因:" + e.getMessage());
			return "";
		}
	}
	...
	/**
	 * 
	 * @Title: delete @Description: 删除用户组 @param @param request @param @param
	...
	public String delete(HttpServletRequest request) {
		...
		try {
			...
			e.printStackTrace();
			log.error("[UserGroupController-delete()]：错误原因:" + e.getMessage());
			return "";
		}
	}
}
